...
echo $book;                                         //Срабатывает функция __toString()

$book->test = "no_exists";                          //Срабатывает функция __set()
echo $book->name;                                   //Срабатывает функция __get()

$obj1 = A::createInstanceObject();
$obj2 = A::createInstanceObject();
echo "<hr><br>";
var_dump($obj1);
echo "<br>";
var_dump($obj2);                                    //вернулся ранее созданный объект - obj1